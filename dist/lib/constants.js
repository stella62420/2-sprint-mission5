...
exports.REFRESH_TOKEN_EXPIRES_IN = exports.REFRESH_TOKEN_SECRET = exports.JWT_EXPIRES_IN = exports.JWT_SECRET = exports.PUBLIC_PATH = exports.STATIC_PATH = exports.PORT = void 0;
const dotenv_1 = __importDefault(require("dotenv"));
const path_1 = __importDefault(require("path"));
dotenv_1.default.config({ path: path_1.default.resolve(__dirname, '../.env') });
exports.PORT = Number(process.env.PORT || 4000);
exports.STATIC_PATH = path_1.default.resolve(process.cwd(), 'public');
exports.PUBLIC_PATH = exports.STATIC_PATH;
