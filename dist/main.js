...
const articlesRouter_1 = __importDefault(require("./articles/articlesRouter"));
const productsRouter_1 = __importDefault(require("./products/productsRouter"));
const commentsRouter_1 = __importDefault(require("./comments/commentsRouter"));
